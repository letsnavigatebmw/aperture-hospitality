        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
            ...
            <div style={{ background: 'var(--dark2)', border: '1px solid #3a3733', padding: '3rem' }}>
              ...
              <a href="/contact?product=workspace-kit" style={{ display: 'block', textAlign: 'center', padding: '1.5rem 2rem', background: '#B8924A', color: '#FFFFFF', border: 'none', width: '100%', boxSizing: 'border-box', borderRadius: '0px', textDecoration: 'none', transition: 'all 0.3s', marginBottom: '1rem', cursor: 'pointer' }} onMouseEnter={(e) => { e.currentTarget.style.background = '#9a7a3e'; }} onMouseLeave={(e) => { e.currentTarget.style.background = '#B8924A'; }}>
