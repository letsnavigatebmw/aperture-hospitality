...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section style={{ background: '#1C1A17', minHeight: '90vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', width: '100%', padding: '7rem clamp(1.5rem, 5vw, 4rem) 0', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300, fontSize: 'clamp(3rem, 7.5vw, 6.5rem)', lineHeight: 1, color: '#F0EDE6', letterSpacing: '-0.02em', maxWidth: '15ch', margin: 0, marginBottom: '0' }}>
            Clarity<br/>Over <em style={{ fontStyle: 'italic', color: '#B8924A' }}>Data.</em><br/>Growth<br/>Over Noise.
          </h1>
        </div>

        {/* Hero Foot */}
        <div style={{ borderTop: '1px solid rgba(240,237,230,0.07)', padding: '2.5rem clamp(1.5rem, 5vw, 4rem) 4rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'end', maxWidth: '1140px', margin: '2.5rem auto 0', position: 'relative', zIndex: 1 }} className="hero-foot">
      ...
      {/* FINAL CTA */}
      <section style={{ background: '#1C1A17', padding: '7rem clamp(1.5rem, 5vw, 4rem)' }}>
        <div style={{ maxWidth: '1140px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6rem', alignItems: 'center' }} className="final-inner">
          <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', background: 'rgba(240,237,230,0.06)' }} className="cta-stack">
            {[
              ...
              <Link key={i} href={cta.link} style={{ background: '#1C1A17', padding: '1.75rem 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem', transition: 'background 0.2s', textDecoration: 'none', cursor: 'pointer' }} className="cta-item" onMouseEnter={(e) => (e.currentTarget.style.background = '#242219')} onMouseLeave={(e) => (e.currentTarget.style.background = '#1C1A17')}>
                <div>
