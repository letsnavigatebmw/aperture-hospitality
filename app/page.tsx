    ...
    <>
      ...
      <div className="border-b border-rule">
        <div className="container-max py-16 md:py-20">
          <div className="section-label">Boutique Hospitality Consulting</div>
          <h1 className="font-display text-5xl md:text-6xl font-light leading-tight tracking-tighter mb-8 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-end">
            <p className="text-lg md:text-xl leading-relaxed text-muted max-w-xl">
              Founded in 2021, Aperture Hospitality advises owners, investors, and operators across real estate, luxury travel, and wine &amp; spirits on the marketing, sales, and operations decisions that unlock value and reposition a business for real growth.
            </p>
