        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto' }}>
          ...
          <div style={{ maxWidth: '800px' }}>
            <h2 style={{
              ...
              The future doesn't belong to businesses with the most data.
            </h2>
            ...
            <p style={{
              ...
              It belongs to businesses that know what to do with it.
            </p>
            ...
            <p style={{
              ...
              At Aperture, we believe intelligence is the bridge between information and opportunity.
            </p>

            <div style={{ borderTop: '1px solid #2e2b26', paddingTop: '2.5rem' }}>
              <p style={{
                fontSize: '1rem',
                fontWeight: 300,
                lineHeight: 1.8,
              ...
              <p style={{
                ...
                Help organizations see more clearly, act more decisively, and grow more predictably.
              </p>
              <p style={{
                fontSize: '1.0625rem',
                fontWeight: 300,
                ...
                Because growth shouldn't be accidental.<br/>
                <span style={{ color: '#B8924A' }}>It should be engineered.</span>
              </p>
            </div>
          </div>
        </div>
