    ...
    <>
      ...
      <section style={{ background: '#1C1A17', minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr', alignItems: 'center', padding: 'clamp(5rem, 8vw, 7rem) clamp(1.5rem, 5vw, 4rem)', gap: '3rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300, fontSize: 'clamp(2.8rem, 5.2vw, 4.8rem)', lineHeight: 1.05, color: '#F0EDE6', letterSpacing: '-0.01em', marginBottom: '2rem' }}>
            A <em style={{ fontStyle: 'italic', color: '#B8924A' }}>Methodology.</em><br/>Not a Menu of Services.
          </h1>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', display: 'grid', gridTemplateColumns: '5fr 7fr', gap: '6rem', alignItems: 'start' }} className="philosophy-inner">
          <div>
            ...
            <p style={{ fontSize: '0.9rem', color: '#6B6760', lineHeight: 1.8, fontWeight: 300 }}>
              Predictable growth is never created by marketing alone. It emerges when strategy, people, process, technology, data, capital and execution operate as one connected commercial system.
            </p>
      ...
      <section style={{ background: '#2A2723', padding: 'clamp(3rem, 6vw, 5rem) clamp(1.5rem, 5vw, 4rem)' }}>
        <div style={{ maxWidth: '1140px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem', flexWrap: 'wrap' }} className="footer-inner">
            {/* Logo + Branding */}
            ...
            {/* Links */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', fontWeight: 500 }} className="nav-links">
