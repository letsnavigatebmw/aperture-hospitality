...
export default function TrafficSystemPage() {
  return (
    <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '5rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(3rem, 5.5vw, 4.5rem)', fontWeight: 300, lineHeight: 1.08, color: '#F0EDE6', marginBottom: '1.75rem' }}>
                Drive Qualified<br/><em style={{ fontStyle: 'italic', color: '#B8924A' }}>Traffic & Leads.</em>
              </h1>
              <p style={{ fontSize: '1.0625rem', fontWeight: 300, lineHeight: 1.8, color: '#F0EDE6', marginBottom: '2.5rem', maxWidth: '44ch' }}>
                Proven framework for driving qualified leads and traffic to your business. Data-driven targeting and conversion optimization built in from day one.
              </p>
            ...
            <div style={{ background: '#2e2b26', border: '1px solid #3a3733', padding: '3rem' }}>
              <div style={{ fontSize: '0.625rem', fontWeight: 500, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#B8924A', marginBottom: '2rem' }}>What You Get</div>
      ...
      {/* NEWSLETTER SECTION */}
      <NewsletterSection inputId="newsletter-email-traffic" />
