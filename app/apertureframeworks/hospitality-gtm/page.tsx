    ...
    <>
      ...
      <section style={{ padding: 'clamp(5rem, 10vw, 9rem) 0', background: '#E8E4DB', borderBottom: '2px solid #B8924A' }}>
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 0, borderTop: '2px solid #B8924A' }}>
            {[
              ...
              <div key={i} style={{ padding: '2.5rem 2.5rem 2.5rem ' + (i % 2 === 1 ? '0' : '2.5rem'), borderRight: i % 2 === 0 ? '2px solid #B8924A' : 'none', borderBottom: i < 2 ? '2px solid #B8924A' : 'none' }}>
