        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, borderTop: '1px solid #D4CFC6' }}>
            {[
              ...
              <div key={i} style={{ padding: '2.5rem 2.5rem 2.5rem ' + (i === 2 ? '0' : '2.5rem'), borderRight: i !== 2 ? '1px solid #D4CFC6' : 'none' }}>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', borderTop: '1px solid #2e2b26' }}>
            {[
              ...
              <div key={i} style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '2rem', padding: '2.5rem 0', borderBottom: i < 3 ? '1px solid #2e2b26' : 'none', alignItems: 'flex-start' }}>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, borderTop: '1px solid #D4CFC6' }}>
            {[
              ...
              <div key={i} style={{ padding: '2rem 2rem 2rem ' + (i % 3 === 2 ? '0' : '2rem'), borderRight: i % 3 !== 2 ? '1px solid #D4CFC6' : 'none', borderBottom: i < 3 ? '1px solid #D4CFC6' : 'none' }}>
