    ...
    <>
      ...
      <section style={{ padding: 'clamp(5rem, 10vw, 9rem) 0', background: '#E8E4DB', borderBottom: '2px solid #B8924A' }}>
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, borderTop: '2px solid #B8924A' }}>
            <div style={{ padding: '3rem 3rem 3rem 0', borderRight: '2px solid #B8924A' }}>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, borderTop: '2px solid #3a3733' }}>
            {[
              ...
              <div key={i} style={{ padding: i % 3 === 2 ? '2.5rem 0 2.5rem 2.5rem' : i % 3 === 1 ? '2.5rem 2.5rem' : '2.5rem 2.5rem 2.5rem 0', borderRight: i % 3 !== 2 ? '2px solid #3a3733' : 'none', borderBottom: i < 3 ? '2px solid #3a3733' : 'none' }}>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '6rem', alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <div style={{ background: '#E8E4DB', border: '2px solid #B8924A', padding: '2rem' }}>
                ...
                <div style={{ fontSize: '0.75rem', fontWeight: 400, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#6B6760', marginBottom: '1.5rem', paddingBottom: '1.5rem', borderBottom: '2px solid #B8924A' }}>Los Angeles, CA · Nov 2023 – Aug 2024</div>
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'flex-start' }}>
            <div>
              ...
              <ul style={{ listStyle: 'none', borderTop: '2px solid #3a3733', margin: 0, padding: 0 }}>
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1rem 0', borderBottom: '2px solid #3a3733', fontSize: '0.9375rem', fontWeight: 300, color: '#F0EDE6', lineHeight: 1.6 }}>
