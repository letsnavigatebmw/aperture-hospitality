          ...
          {[
            ...
            <div key={i} style={{ display: 'grid', gridTemplateColumns: '80px 1fr auto', gap: '2rem', alignItems: 'start', padding: '2.5rem 0', borderTop: '1px solid #D4CFC6', borderBottom: i === 5 ? '1px solid #D4CFC6' : 'none' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.75rem', paddingTop: '0.375rem', flexShrink: 0 }}>
                <span style={{ fontSize: '0.5rem', fontWeight: 500, letterSpacing: '0.14em', textTransform: 'uppercase', padding: '0.3rem 0.75rem', border: fw.status === 'published' ? '1px solid #B8924A' : '1px solid #D4CFC6', color: fw.status === 'published' ? '#B8924A' : '#D4CFC6' }}>
                  {fw.status === 'published' ? 'Published' : 'Coming Soon'}
                </span>
                {fw.link ? (
                  ...
                  <span style={{ fontSize: '0.625rem', fontWeight: 500, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#D4CFC6', borderBottom: 'none', paddingBottom: '1px', whiteSpace: 'nowrap', cursor: 'default' }}>
                    Coming Soon
                  </span>
                )}
              </div>
