          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'flex-end' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
                ...
                <span style={{ fontSize: '0.6875rem', fontWeight: 500, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#F0EDE6' }}>Go-to-Market</span>
              </div>
              <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(3rem, 5.5vw, 5rem)', fontWeight: 300, lineHeight: 1.06, color: '#F0EDE6', margin: 0 }}>
                The Hospitality<br/>GTM<br/><em style={{ fontStyle: 'italic', color: '#B8924A' }}>Framework.</em>
              </h1>
            </div>
            <div style={{ paddingTop: '0.5rem' }}>
              <p style={{ fontSize: '1.0625rem', fontWeight: 300, lineHeight: 1.8, color: '#F0EDE6', margin: 0 }}>
                How boutique hotels, luxury travel brands, and independent operators should think about go-to-market strategy differently from generic B2B or B2C playbooks. Who your actual buyer is, where they are, and what it takes to earn their attention in a crowded market.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
          <div style={{ marginBottom: '4rem' }}>
            ...
            <p style={{ fontSize: '1.0625rem', fontWeight: 300, lineHeight: 1.8, color: '#6B6760', marginBottom: '1rem' }}>
              This framework is currently being published. Check back soon for the complete breakdown of hospitality go-to-market strategy.
            </p>
          </div>
